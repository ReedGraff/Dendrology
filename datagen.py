...
def image_dataset_from_directory(
    ...
    **kwargs,
    ...
    Args:
      ...
      siamese_type: Shifts data to match that required to train Siamese Networks.
        Defaults to None, supports `contrastive`, `triplet`, `quadruplet`
...
def train_loop(input_folder_path, Epoch_Size, Batch_Size, X_train_batch = [], Y_train_batch = []):
                ...
                while len(Left_Structure.keys()) > 0:
                    ...
                    while len(Right_Structure.keys()) > 0:
                        ...
                        #TODO: Write a better Div_This function... that allows a range of bias for a dataset...
